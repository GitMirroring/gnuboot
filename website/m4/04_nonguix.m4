...
## CHECK_GNUBOOT_WEBSITE_NONGUIX_DEPENDENCIES -- Check dependencies for non Guix builds
...
# CHECK_GNUBOOT_WEBSITE_NONGUIX_DEPENDENCIES -- Check dependencies for non Guix builds
#
# Usage: CHECK_GNUBOOT_WEBSITE_NONGUIX_DEPENDENCIES(want_lighttpd)
#
AC_DEFUN([CHECK_GNUBOOT_WEBSITE_NONGUIX_DEPENDENCIES],
