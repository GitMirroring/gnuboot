...
chapter](https://www.gnu.org/software/gnuboot/manual/gnuboot.html#Building-GNU-Boot-from-source)
in the [GNU Boot
manual](http://localhost:8086/software/gnuboot/docs/#manuals) for
more details about this issue.

Also note that the table below is meant for the [GNU Boot
images](http://localhost:8086/software/gnuboot/manual/gnuboot.html#index-flash-images)
